...
public class ProcessInfo {
	...
	private static final String LOG_TAG = "SpecialTest-" + ProcessInfo.class.getSimpleName();

	private static final String PACKAGE_NAME = "com.cocoatest.st";
	...
	public List<Programe> getRunningProcess(Context context) {
		Log.d(LOG_TAG, "get running processes");
