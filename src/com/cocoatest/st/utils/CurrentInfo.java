...
public class CurrentInfo {
	private static final String LOG_TAG = "SpecialTest-CurrentInfo";
	...
	private static final String CURRENT_NOW_HUAWEI = "/sys/class/power_supply/Battery/current_now";
	...
	public Long getCurrentValue() {
		File f = null;
		Log.d(LOG_TAG, "build model = " + BUILD_MODEL);
